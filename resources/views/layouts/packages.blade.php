...
<body>
    ...
    <!--================ Start Banner Area =================-->
    <section class="banner_area" id="top">
    ...
    <div class="col-lg-4 col-md-6 all">
        <div class="portfolio_box">
            <div class="single_portfolio">
                <img class="img-fluid w-100" src="{{ asset('uploads/' . $paquete->imagen) }}" alt="{{ $paquete->nombre }}">
                <div class="overlay"></div>
                <a href="{{ asset('uploads/' . $paquete->imagen) }}" class="img-gal" target="_blank">
                    <div class="icon">
            ...
            <div class="short_info">
                <h4>
                    <!-- Usar formulario para enviar ID -->
